...
class Generate_otp(Tk):
    ...
    def Labels(self):
        ...
        self.a = Label(self, text="OTP is valid for 1 minutes.", font = "TimesNewRoman 14",bg= "#4682B4", fg="white").place(x= 360, y= 290)
        ...
        # self.simpli_logo = PhotoImage(file = "CodeHer.png")
